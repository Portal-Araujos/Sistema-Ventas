...
// GET: LEER TODOS LOS USUARIOS Y SUS ROLES
...
// POST: CREAR UN NUEVO USUARIO (Con Argon2)
export async function POST(request: Request) {
  try {
    ...
    // Encriptación Argon2 de Grado Militar
...
// PUT: CAMBIAR ESTADO ACTIVO / INACTIVO O EDITAR
