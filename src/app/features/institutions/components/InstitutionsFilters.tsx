      ...
      {showAdvanced && (
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 animate-in fade-in slide-in-from-top-2">
          ...
          <div>
            ...
            <select
              disabled={!filtros.cantonId}
              className="w-full h-9 border rounded-md px-2 text-xs bg-white disabled:bg-gray-100"
              value={filtros.parroquiaId}
              onChange={(e) =>
                setFiltros({ ...filtros, parroquiaId: e.target.value })
              }
            >
              <option value="">Todas</option>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFiltros({ ...filtros, tamano: e.target.value })
              }
            >
          ...
          <div>
            ...
            <select
              className="w-full h-9 border rounded-md px-2 text-xs bg-white"
              value={filtros.sostenimientoId}
              onChange={(e) =>
                setFiltros({ ...filtros, sostenimientoId: e.target.value })
              }
            >
              <option value="">Todos</option>
