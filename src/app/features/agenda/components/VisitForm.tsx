  ...
  return (
    <Dialog>
      ...
      <DialogTrigger asChild>
        <Button size="sm" className="w-full sm:w-auto bg-primary/10 text-primary hover:bg-primary hover:text-white transition-colors">
      ...
      <DialogContent className="sm:max-w-md bg-white rounded-xl p-6">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-900">Resultado de la Visita</DialogTitle>
          <p className="text-xs font-medium text-primary mt-1">{institutionName}</p>
        </DialogHeader>

        <form className="space-y-5 mt-4">
          
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-gray-700">Estado de la gestión <span className="text-red-500">*</span></Label>
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-gray-700">Resumen y Acuerdos <span className="text-red-500">*</span></Label>
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-gray-700">Fecha del próximo contacto</Label>
          ...
          <DialogFooter className="pt-4 border-t border-gray-100 flex gap-2 sm:justify-end">
            <DialogClose asChild>
              <Button type="button" variant="outline" className="w-full sm:w-auto text-gray-600 bg-white hover:bg-gray-50">
                Cancelar
              </Button>
            </DialogClose>
            <Button type="button" className="w-full sm:w-auto bg-primary hover:bg-primary-light text-white font-medium">
